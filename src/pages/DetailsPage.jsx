...
<>
  ...
  <section className="flex gap-8 max-w-5xl mx-auto px-2 mb-16 items-start">
    ...
    <main className="space-y-4">
      ...
      <div className="relative">
        ...
        <img src="http://picsum.photos/1080/720.webp" className="aspect-video rounded-md" alt="" />
        </Suspense>
      </div>
      <div className="flex gap-x-4">
        <div
          className="flex flex-1 gap-x-2 items-center font-[500] text-xl font- bg-green-400 text-white justify-center py-3 rounded-full">
          <FaWhatsapp size={24} /> Share
        </div>
        <div
          className="flex flex-1 gap-x-2 items-center text-xl font-[500] bg-black text-white justify-center py-3 rounded-full">
          <FaXTwitter size={20} /> Share
        </div>
        <div
          className="flex flex-1 gap-x-2 items-center text-xl font-[500] bg-blue-900 text-white justify-center py-3 rounded-full">
      ...
      <div className="flex gap-2">
        <div className="flex flex-1 border p-4 rounded-md gap-4">
          <Suspense fallback={<Loader />}>
          <img className="w-16 h-16 rounded-full" src="http://picsum.photos/50.webp" alt="" />
          </Suspense>
  ...
  <div className={`grid fixed inset-0 z-50 glass ${!visible && "hidden" }`}>
    <div
      className="bg-white max-w-[500px] w-full place-self-center rounded-lg overflow-hidden animate__animated animate__bounceIn">
