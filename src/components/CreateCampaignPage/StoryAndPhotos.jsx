...
<section className='grid gap-y-4'>
    ...
    <textarea cols="30" rows="10" placeholder='Enter your story'
        className='p-3 border border-gray-200 rounded-lg'></textarea>

    <div className='font-bold'>Select upto 2 photos for your campaign</div>
